...
-- HÀM THỐNG KÊ BÁO CÁO: TÍNH DOANH THU THEO THÁNG VỚI THÁNG VÀ NĂM LÀ BIẾN ĐẦU VÀO
...
--HÀM BÁO CÁO HIỂN THỊ SỐ LƯỢNG KHÁCH THUÊ PHÒNG THEO THÁNG. vỚI THÁNG VÀ NĂM LÀ BIẾN ĐẦU VÀO
...
SET @doanhthu = dbo.FN_TINH_DOANH_THU(1, 2022);
SELECT @doanhthu AS 'Doanh thu thang 1 nam 2022';
